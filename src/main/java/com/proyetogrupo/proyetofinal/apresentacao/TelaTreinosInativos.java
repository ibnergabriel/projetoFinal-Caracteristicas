 ...
 * @author pedro
 */
public class TelaTreinosInativos extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(TelaTreinosInativos.class.getName());
    ...
    private void initComponents() {
        ...
        btnCarregarTreinosI.setText("Carregar treinos Inativos");
        btnCarregarTreinosI.addActionListener(this::btnCarregarTreinosIActionPerformed);
        ...
        panelFiltroLayout.setHorizontalGroup(
            ...
            .addGroup(panelFiltroLayout.createSequentialGroup()
                ...
                .addGap(44, 44, 44)
                .addComponent(btnCarregarTreinosI)
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Treinos Inativos", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    private void btnCarregarTreinosIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCarregarTreinosIActionPerformed
        // TODO add your handling code here:
        carregarTreinosInativos();
    }//GEN-LAST:event_btnCarregarTreinosIActionPerformed
    ...
    private void carregarTreinosInativos() {
        ...
        try {
            ...
            // Preenche apenas os treinos com status FINALIZADO
            for (Treino t : treinos) {
                if (!"FINALIZADO".equalsIgnoreCase(t.getStatus())) {
                    continue; // pula treinos que não estão finalizados
                }
                ...
                model.addRow(new Object[]{
                    ...
                    t.getStatus()                             // Status (FINALIZADO)
                });
            }

        } catch (SQLException e) {
            logger.log(Level.SEVERE, "Erro ao carregar treinos inativos", e);
            JOptionPane.showMessageDialog(
                    this,
    ...
    private javax.swing.JButton btnCarregarTreinosI;
